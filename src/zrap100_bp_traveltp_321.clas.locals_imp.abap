CLASS LHC_ZRAP100_R_TRAVELTP_321 DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
  CONSTANTS:
...
CLASS LHC_ZRAP100_R_TRAVELTP_321 IMPLEMENTATION.
  METHOD GET_GLOBAL_AUTHORIZATIONS.
  ENDMETHOD.
  METHOD earlynumbering_create.
  DATA:
  entity           TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_321,
...
ELSE.
  ...
  SELECT SINGLE FROM zrap100_atrav321 FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
  "Get max travel ID from draft table
  SELECT SINGLE FROM zrap100_dtrav321 FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
...
READ ENTITIES OF ZRAP100_R_TravelTP_321 IN LOCAL MODE
 ENTITY Travel
...
MODIFY ENTITIES OF ZRAP100_R_TravelTP_321 IN LOCAL MODE
  ENTITY Travel
    UPDATE SET FIELDS
...
METHOD deductDiscount.
  DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_321.
...
METHOD copyTravel.
   DATA:
      travels       TYPE TABLE FOR CREATE zrap100_r_traveltp_321\\travel.
